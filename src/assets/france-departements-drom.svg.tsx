const CarteDeFranceDromSvg = (props:any) => (
  <svg
  ...
  >
    ...
    <g
      className="region region-04"
      data-nom="La R\xE9union"
      data-code_insee={4}
    >
      <path
        data-nom="La R\xE9union"
        data-numerodepartement={974}
...
export default CarteDeFranceDromSvg;
// source : https://github.com/regisenguehard/carte-france-svg
