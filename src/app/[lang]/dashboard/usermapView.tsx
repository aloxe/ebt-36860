...
import { MapFullScreen } from "@/components/stats/mapFullscreen";
  ...
  return (
    <div className="bg-white rounded-lg border border-blue-200 text-left text-blue-900 p-2 m-2 sm:p-4 sm:m-4">
      ...
      <div className="w-full h-90 overflow-hidden text-center">
        {mapPolygons && (
          <MyMapComponent departements={departements} dataCommunes={mapPolygons} showDep={showDep} showCom={showCom} />
        )}
      </div>
    </div>
    )
