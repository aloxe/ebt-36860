    ...
    return (
        <div className="relative inline-block text-left dropdown">
          ...
          <div className="opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right -translate-y-2 scale-95">
            ...
            {array.map((entry) => {
              <div className="py-1">
                <a href="{entry.url}" className="text-gray-700 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left" role="menuitem" >{entry.label}</a>
              </div>
            })}
            </>
              <div className="px-4 py-3">
                <p className="text-sm leading-5">Signed in as</p>
                <p className="text-sm font-medium leading-5 text-gray-900 truncate">¿ʔ</p>
              </div>
              <div className="py-1">
                <button className="text-gray-700 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left" role="menuitem" >Sign out</button>
              </div>
              <div className="py-1">
